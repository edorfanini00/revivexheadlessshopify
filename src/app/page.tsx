  ...
  return (
    <div className="relative flex-1 flex flex-col">
      ...
      <div className="relative min-h-[calc(100vh-12px)] flex flex-col rounded-[10px] overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col px-4 sm:px-6 lg:px-20 w-full max-w-[1600px] mx-auto">
          
          <div className="h-[88px]" />

          <div className="flex-1 flex flex-col justify-center max-w-[650px] pb-20 sm:pb-44 pt-6">
